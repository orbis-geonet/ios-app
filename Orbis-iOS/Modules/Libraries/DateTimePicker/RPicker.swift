...
@objc open class RPicker: NSObject {
    ...
    @objc class func selectDate(title: String? = nil,
        ...
        guard let vc = controller(title: title, cancelText: cancelText, doneText: doneText, datePickerMode: datePickerMode, selectedDate: selectedDate, minDate: minDate, maxDate: maxDate, type: .date, style: style, timeInterval: timeInterval) else { return }
    ...
    */
    ...
    private class func controller(title: String? = nil,
                          ...
                          style: RDatePickerStyle = .Wheel,
                          timeInterval: Int = 1) -> RPickerController? {
        ...
        if let cc = UIWindow.currentController {
            if RPicker.sharedInstance.isPresented == false {
                ...
                let vc = RPickerController(title: title, cancelText: cancelText, doneText: doneText, datePickerMode: datePickerMode, selectedDate: selectedDate, minDate: minDate, maxDate: maxDate, dataArray: dataArray, selectedIndex: selectedIndex, type: type, style: style, timeInterval: timeInterval)
...
class RPickerController: UIViewController {
    ...
    private let barViewHeight: CGFloat = 44.toCGFloat.relativeToIphone8Width()
    private let pickerHeight: CGFloat = 216.toCGFloat.relativeToIphone8Width()
    private let buttonWidth: CGFloat = 84.toCGFloat.relativeToIphone8Width()
    private let lineHeight: CGFloat = 0.5
    private let buttonColor = UIColor(named: AppColors.appBlack.rawValue)!
    private let lineColor = UIColor(named: AppColors.appOffWhite2.rawValue)!
            ...
            if #available(iOS 14.0, *) {
                if datePickerStyle == .Wheel {
                    ...
                    if datePicker.datePickerMode == .dateAndTime {
                        height = height + 428.toCGFloat.relativeToIphone8Width()
                    } else if datePicker.datePickerMode == .date {
                        height = height + 386.toCGFloat.relativeToIphone8Width()
                    } else {
                        height = height + pickerHeight
                    }
                }
    ...
    private func setUpThemeMode(isDark: Bool) {
        ...
        if isDark {
            ...
            titleLabel.textColor = UIColor(named: AppColors.appBlack.rawValue)!
    ...
    private lazy var datePicker: UIDatePicker = {
        ...
        picker.minuteInterval = timeInterval
    ...
    private lazy var titleLabel: UILabel = {
        ...
        label.font = UIFont(name: "Roboto-Medium", size: 14.toCGFloat.relativeToIphone8Width())
    ...
    private lazy var doneButton: UIButton = {
        ...
        button.titleLabel?.font = UIFont(name: "Roboto-Bold", size: 14.toCGFloat.relativeToIphone8Width())
...
extension RPickerController: UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    func pickerView(_ pickerView: UIPickerView, viewForRow row: Int, forComponent component: Int, reusing view: UIView?) -> UIView {
        ...
        if (pickerLabel == nil) {
            pickerLabel = UILabel()
            pickerLabel?.font = UIFont(name: "Roboto-Medium", size: 16.toCGFloat.relativeToIphone8Width())
