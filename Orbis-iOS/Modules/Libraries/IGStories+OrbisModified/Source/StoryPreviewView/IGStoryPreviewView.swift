...
class OrbisStoryPreviewView: UIView {
    ...
    lazy var snapsCollectionView: UICollectionView! = {
        ...
        cv.register(OrbisStoryPreviewCell.self, forCellWithReuseIdentifier: OrbisStoryPreviewCell.reuseIdentifier)
