...
//            self.manager.fetchPlacesList(location: self.userLocation, distance: self.searchDistanceInKM, searchText: self.searchText, page: self.pageNumber, limit: self.offsetVal) { [weak self] (data, err) in
            self.manager.fetchPlacesList(location: Constants.location!.coordinate, distance: self.searchDistanceInKM, searchText: self.searchText, page: self.pageNumber, limit: self.offsetVal) { [weak self] (data, err) in
